...
const getInputValue = async () => {
  ...
  createText("Guarda tutti i miei progetti pubblici su: \
    ...
    commandResponse(true, value);
    createText("<a href='https://discord.gg/il_tuo_invito' target='_blank'><i class='fab fa-discord'></i> Discord: <span class='green'>Simontech</span></a>");
    ...
    createText("<a href='https://www.instagram.com/tuo_username/' target='_blank'><i class='fab fa-instagram'></i> Instagram: <span class='green'>@tuo_username</span></a>");
  }
